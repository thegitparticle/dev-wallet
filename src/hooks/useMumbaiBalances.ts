...
import { mumbaiAlchemy } from "../utils/alchemyConfig";

export const useMumbaiBalances = (address: string) => {
	...
	const fetchBalances = async () => {
		...
		const balances = await mumbaiAlchemy.core.getTokenBalances(address);
